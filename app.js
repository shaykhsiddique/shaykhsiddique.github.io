  ...
  template: `
    <div class="row align-items-top flex-column flex-lg-row">
      <div class="col-lg-8 col-12 pt-2">
        <div style="position:relative; min-height:250px" data-aos="fade-up">
          ...
          <center><div class="typewriterClass"
            style="position:absolute;top:28px;left:28px;z-index:2;;padding:16px 22px;border-radius:12px;">
            <h3>{{ typingText }}</h3>
          </div></center>
        </div>
